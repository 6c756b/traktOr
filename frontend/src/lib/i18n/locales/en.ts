...
export default {
  ...
  "detail.castHeading": "Cast",
  "detail.castPhotoAlt": "Photo of {name}",
  "person.filmographyHeading": "Filmography",
  "person.bioMissing": "No biography available.",
  ...
  "search.addToLibrarySuccess": "Added to library.",
  "search.addToLibraryError": "Couldn't add to library.",
